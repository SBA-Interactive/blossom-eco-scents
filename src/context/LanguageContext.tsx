...
const translations: Translations = {
  ...
  "products.scentFamily": { en: "Scent Family", gr: "Οικογένεια Αρώματος" },
  "products.sizeLabel": { en: "Size", gr: "Μέγεθος" },
  "products.price": { en: "Price Range", gr: "Εύρος Τιμής" },
  "products.features": { en: "Features", gr: "Χαρακτηριστικά" },
  "products.allPrice": { en: "All Prices", gr: "Όλες οι Τιμές" },
  "products.clearAll": { en: "Clear All", gr: "Καθαρισμός Όλων" },
  "products.apply": { en: "Apply", gr: "Εφαρμογή" },
  "products.showing": { en: "Showing", gr: "Εμφάνιση" },
  "products.of": { en: "of", gr: "από" },
  "products.products": { en: "products", gr: "προϊόντα" },
  ...
  // Contact Page FAQ
  "contact.faq.title": { en: "Frequently Asked Questions", gr: "Συχνές Ερωτήσεις" },
  "contact.faq.about": { en: "What is Blossom and what is your mission?", gr: "Ποια είναι η Blossom και ποιά είναι η αποστολή της;" },
  "contact.faq.aboutAnswer": { en: "Blossom is a sustainable fragrance brand that transforms discarded fruit peels into premium, eco-friendly perfumes. Our mission is to create beautiful scents while reducing waste and protecting the environment. We believe luxury fragrance should never come at the planet's expense.", gr: "Η Blossom είναι μια βιώσιμη μάρκα αρωμάτων που μετατρέπει απορριφθέντες φλούδες φρούτων σε πρωτοποριακά αρώματα φιλικά προς το περιβάλλον. Η αποστολή μας είναι να δημιουργούμε υπέροχα αρώματα μειώνοντας τα απόβλητα και προστατεύοντας το περιβάλλον. Πιστεύουμε ότι η πολυτελής αρωματοποιία δεν πρέπει ποτέ να επιβαρύνει τον πλανήτη." },
  "contact.faq.sustainability": { en: "How sustainable are your products?", gr: "Πόσο βιώσιμα είναι τα προϊόντα σας;" },
  "contact.faq.sustainabilityAnswer": { en: "Our products are 100% sustainable. We upcycle fruit peels that would otherwise go to waste, use cold-press extraction to preserve natural oils, package in recyclable glass bottles, and ship in carbon-neutral packaging. Every purchase supports our zero-waste mission.", gr: "Τα προϊόντα μας είναι 100% βιώσιμα. Ανακυκλώνουμε φλούδες φρούτων που θα πετιόνταν, χρησιμοποιούμε ψυχρή πίεση για τη διατήρηση των φυσικών ελαίων, συσκευάζουμε σε ανακυκλώσιμα γυάλινα μπουκάλια και αποστέλλουμε σε ουδέτερων ως προς τον άνθρακα συσκευασίες. Κάθε αγορά υποστηρίζει την αποστολή μας για μηδενικά απόβλητα." },
  "contact.faq.ingredients": { en: "What ingredients are in your fragrances?", gr: "Ποια συστατικά περιέχουν τα αρώματά σας;" },
  "contact.faq.ingredientsAnswer": { en: "Our fragrances are made from 100% natural ingredients with no synthetic chemicals, parabens, or phthalates. They're cruelty-free, vegan, and suitable for ages 10+. Each batch is carefully crafted and quality-tested to ensure the highest standards.", gr: "Τα αρώματά μας παρασκευάζονται από 100% φυσικά συστατικά χωρίς συνθετικές χημικές ουσίες, παραβένες ή φθαλικές ενώσεις. Είναι cruelty-free, vegan και κατάλληλα για ηλικίες 10+. Κάθε παρτίδα είναι προσεκτικά φτιαγμένη και ελέγχεται για ποιότητα ώστε να διασφαλίζονται τα υψηλότερα πρότυπα." },
  "contact.faq.ordering": { en: "How do I place an order?", gr: "Πώς μπορώ να κάνω παραγγελία;" },
  "contact.faq.orderingAnswer": { en: "To order, simply browse our collection, select your desired fragrance and size, add to cart, and proceed to checkout. We accept all major credit cards (Visa, Mastercard, American Express), PayPal, and Apple Pay, with all transactions secure and encrypted.", gr: "Για να παραγγείλετε, απλώς περιηγηθείτε στη συλλογή μας, επιλέξτε το επιθυμητό άρωμα και μέγεθος, προσθέστε στο καλάθι και προχωρήστε στο ταμείο. Δεχόμαστε όλες τις κύριες πιστωτικές κάρτες (Visa, Mastercard, American Express), PayPal και Apple Pay, με όλες τις συναλλαγές ασφαλείς και κρυπτογραφημένες." },
  "contact.faq.shippingReturns": { en: "What are your shipping and return policies?", gr: "Ποιες είναι οι πολιτικές αποστολής και επιστροφών;" },
  "contact.faq.shippingReturnsAnswer": { en: "Shipping is free on orders over $50, with standard delivery taking 5-7 business days. Express and overnight options are available at checkout. We offer a 30-day return policy for unopened items in original condition - contact our customer service team to initiate a return.", gr: "Η αποστολή είναι δωρεάν για παραγγελίες άνω των $50, με κανονική παράδοση που διαρκεί 5-7 εργάσιμες μέρες. Express και overnight επιλογές είναι διαθέσιμες στο ταμείο. Προσφέρουμε πολιτική επιστροφής 30 ημερών για ανοιχτά προϊόντα στην αρχική τους κατάσταση - επικοινωνήστε με την ομάδα εξυπηρέτησης πελατών για να ξεκινήσετε επιστροφή." },
